...
namespace AutoContentGenerator
{
    ...
    public static class GenerateBlogPost
    {
        ...
        public static async Task<BlogPost> WriteBlogPost(string existingPosts)
        {
            ...
            string prompt = @$"
                You are a blog writer for my blog on the Cleveland Browns called Will The Browns Win, at browns.com
                This is a blog all about the Cleveland Browns - we cover all aspects essential and tangential related to Cleveland, Cleveland Browns Players, Cleveland Browns schedule, etc.
                ...
                author: ""Cleveland Browns Writer""
                tags:
                - ""<tag1>""
                - ""<tag2>""
                - ""<tag3>""
